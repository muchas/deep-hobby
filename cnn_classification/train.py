...
def train(epoch, steps_per_epoch, model, optimizer, criterion, train_loader, test_loader, device):
    model.train()
...
def main(epochs, lr, data_path):
    ...
    for epoch in tqdm(range(epochs)):
        train(epoch, steps_per_epoch, model, optimizer, criterion, train_loader, test_loader, device)
